 ...
 * Original copyright (c) 2020 IOTA Foundation
 */
...
/**
 * Wrapper class for interacting with the Ledger Nano S Burst Application
 *
 * @example
 * import { BurstLedgerApp } from "@burstjs/ledger";
 * const burst = new BurstLedgerApp(transport);
 */
export class BurstLedgerApp {
  transport: any;
